...
public class CoverController {
    ...
    public Result<String> create(@ApiParam(name = "filename")
        ...
        coverEvent.setCoverImage(PdfServiceConstant.ROOT_TEMPLATE_IMAGE + "cover/cover1.jpg");
        pdf.addEventHandler(PdfDocumentEvent.START_PAGE, new CoverEventHandler(coverEvent));
